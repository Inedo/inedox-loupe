...
{
    internal sealed class PromotionLevelSuggestionProvider : ISuggestionProvider
    {
        public async Task<IEnumerable<string>> GetSuggestionsAsync(IComponentConfiguration config)
        {
            ...
            var levels = await client.GetPromotionLevelsAsync(tenant, product, application).ConfigureAwait(false);
